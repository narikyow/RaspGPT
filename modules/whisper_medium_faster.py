...
class FasterWhisperMedium:
    def __init__(self, model_size="./modules/faster-whisper-medium", device="cpu", compute_type="int8"):     
        
        # mediumは重いため、beam=1とする。精度は高い。
        self.batch_size=1
        self.beam_size=1
...
if __name__ == "__main__":
    ...
    fws = FasterWhisperMedium(
        model_size="./modules/faster-whisper-medium",   # "small", "medium", "medium.en" など
